...
png("Time Series Steps by Interval.png")
with(stepint,plot(interval, avgstep, type = "l", xlab = "Interval", ylab = "Average # Steps", main = "Average Steps Broken Down by Interval"))
...
png("Histogram of Steps by Day.png")
